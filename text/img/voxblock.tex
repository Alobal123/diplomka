...
\node[layer={150pt}{30pt}, below = of input]  (c3) {3D Convolution \\ $3\times3\times3$ sized filters};

\node[layer={150pt}{30pt}, below right = of input]  (c1) {3D Convolution \\ $1\times1\times1$ sized filters};
