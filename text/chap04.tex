...
\begin{figure}[!h]
	\centering
	\subfloat[Original point cloud representation provided by the authors of PointNet (2048 points)]{\includegraphics[width=0.44\columnwidth]{./img/pnet_plane_1}}
	\qquad
	\subfloat[Our point cloud representation (2048 points)]{\includegraphics[width=0.44\columnwidth]{./img/myplane_1}}
