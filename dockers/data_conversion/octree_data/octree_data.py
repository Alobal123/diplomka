...
def convert_one_category(arguments):
    try:
        ...
        os.system('/workspace/bin/octree --filenames {} --output_path {} {}'.format(test_file, test_dir, adaptive))
...
if __name__ == '__main__':
    ...
    log_file.close()
    os.system("/opt/caffe/build/tools/convert_octree_data -help")
    ...
    os.system('/opt/caffe/build/tools/convert_octree_data -shuffle=false -remove=true {} \"{}\" \"{}\" '.format("/", os.path.join(config.output,'test.txt'), os.path.join(config.output,'test_lmdb')))    
    os.system('/opt/caffe/build/tools/convert_octree_data -remove=true {} \"{}\" \"{}\"'.format("/",  os.path.join(config.output,'train.txt'), os.path.join(config.output,'train_lmdb')))
